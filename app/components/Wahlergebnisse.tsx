...
const WAHLEN: Wahl[] = [
  ...
  },
  {
    ...
    datum: '9. Juni 2024',
    gebiet: 'Rhein-Pfalz-Kreis · 153 Stimmbezirke · 50 Sitze',
    typ: 'kw',
    ergebnis: [
      { name: 'CDU',   prozent: 30.7, farbe: '#374151' },
      { name: 'SPD',   prozent: 21.4, farbe: '#ef4444' },
      { name: 'AfD',   prozent: 17.2, farbe: '#3b82f6' },
      { name: 'Grüne', prozent: 11.5, farbe: '#22c55e' },
      { name: 'FWG',   prozent: 11.5, farbe: '#f97316' },
      { name: 'FDP',   prozent:  5.7, farbe: '#eab308' },
      { name: 'Linke', prozent:  1.9, farbe: '#ec4899' },
    ],
    ...
    hinweis: 'CDU 30,7 % & SPD 21,4 % amtlich bestätigt · AfD/Grüne/FWG/FDP/Linke aus amtlicher Sitzverteilung (50 Sitze) abgeleitet · Koalition CDU+SPD+FWG (31 Sitze)',
  },
];
